...
%% Parametri
n = [8, 16, 64]; % Dimensione del blocco per la DCT
R = 10:10:100;
...
for j = 1:numel(n)
    ...
    figure(2);
    plot(R, psnr(:,j),'linewidth', 1.5, 'DisplayName', 'PSNR');
    hold on;
